...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        //   - key를 set 방식으로 관리하기 때문에 더이터의 순서를 관리하지 않고 중복된 key를 허용하지 않는다.
        //   - value는 중복된 값을 저장할 수 있다.
        //   - hasMap, TreeMap, Hashtable, Properties 등이 있다.
        ...
        System.out.println(arrayList.size()); // arrayList의 길이 출력
        ...
        arrayList.add(1, "banana"); // arrayList의 1번째 인덱스에 banana 추가
