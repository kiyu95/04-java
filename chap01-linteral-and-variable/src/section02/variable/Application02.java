...
public class Application02 {
    public static void main(String[] args){
        ...
        * 그 중 기본 자료형 8가지를 먼저 확인힌다.
        ...
        // 논리 데이터 형은 0과 1의 값으로 데이터를 취급하기 때문에 1bit로 표현이 가능하지만 최소단위가 1byte 이기 때문에 1byte의 크기를 갖는다.
