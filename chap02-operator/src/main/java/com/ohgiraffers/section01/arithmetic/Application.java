...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("num1 + num2 = " + num1 + num2); // 207 출력 : 문자열로 취급하기때문에
        System.out.println("num1 + num2 = " + (num1 + num2)); // 27 출력
        System.out.println("num1 - num2 = " + (num1 - num2)); // 13 출력
//        System.out.println("num1 - num2 = " + num1 - num2); // 문자열은 더하기만 가능하다
        System.out.println("num1 * num2 = " + (num1 * num2));
        System.out.println("num1 * num2 = " + num1 * num2); // 곱셈이 더하기보다 연산 우선순위가 높기 때문에 실행이 됨
        System.out.println("num1 / num2 = " + (num1 / num2));
        System.out.println("num1 % num2 = " + (num1 % num2));
    }
}
