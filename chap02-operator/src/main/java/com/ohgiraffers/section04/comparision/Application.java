...
public class Application {
    ...
    public static void main(String[] args){
        ...
        // 비교연산자의 종류
        // == : 왼쪽의 피연산자와 오른쪽의 피연산자가 같다면 true 다르면 false를 반환
        // != : 왼쪽의 피연산자와 오른쪽의 피연산자가 같다면 true 다르면 false를 반환
        ...
        System.out.println(!true); // !true : true의 부정이므로, false
        System.out.println(!false);

        if(!false){
            System.out.println("나는 부정일때 실행해야됨");
        }
...
//        System.out.println("str1과 str2가 같은지 비교 : " + (str2.equals(str1))); // String 비교는 equals를 사용함
