...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        // 적절한 책임을 수행하는 객체 또한 그 객체만 수행할 수 있는 기능이라기 보다 역할의 관점으로 봐라바야 한다.
        // 역할이란 동일한 동작을 수행하는 것을 정의한 것이며 대체 가능성을 의미한다.
        // 부모클래스를 추상화 하는 경우에는 역할의 관점을 바라봐야 한다.
        // 그래야 자식클래스로 생성한 객체들이 서로 역할을 수행하가며 유연한 코드를 작성할 수 있게 된다.
        ...
        Car test = fireCar;
        test.isRunning();
        test.soundHorn(); // fireCar에서 재정의한 soundHorn 호출
//        test.sprayWater(); // test와 fireCar의 크기가 다르기 때문에 sprayWater()는 호출 불가
